document.addEventListener("DOMContentLoaded", () => {
  ...
  const gameDetails = {
    ...
    "Truck Loader Unblocked": {
      image: "images/placeholder.svg?height=120&width=200&query=truck+loader+unblocked+game",
    ...
    "Fireboy and Watergirl": {
      ...
      url: "https://fireboy-and-watergirl-online.github.io/file/", // Updated URL
      description:
  ...
  if (playNowBtn) {
    playNowBtn.addEventListener("click", () => {
      ...
      const mainGameUrl = gameDetails["Fireboy and Watergirl"].url || "https://play.wgplayground.com/ifr/placeholder"
